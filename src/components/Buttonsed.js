...
export const Buttoned = ({reg_open,reg_end,cpiOf}) => {
    ...
    return (
        ...
        <> 
         {stats && (student?.cpi>=cpiOf) && !stads && <button style={{ backgroundColor: "#493D72", color: "white", fontSize: 16, height: 41, 
            ...
            {(!stats || student?.cpi<cpiOf) && <><button style={{ backgroundColor: "#493D72", color: "white", fontSize: 16, height: 41, 
